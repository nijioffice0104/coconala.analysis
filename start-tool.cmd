...
if errorlevel 1 start "" /b "%~dp0runtime\node.exe" server.mjs >nul 2>&1
...
:browser_found
start "" "%BROWSER_EXE%" --remote-debugging-port=9222 --user-data-dir="%~dp0browser-profile" "http://127.0.0.1:4173/"
